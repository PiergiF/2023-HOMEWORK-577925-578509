...
public class Borsa {
	...
	public Map<String,Attrezzo> getContenutoRaggruppatoPerNome(){
		Map<String,Attrezzo> mappaAttrezzi = new HashMap<String,Attrezzo>();
		for(Attrezzo tmp : this.attrezzi) {
			mappaAttrezzi.put(tmp.getNome(), tmp);
		}
		return mappaAttrezzi;
	}
