...
//	}
	...
	private Labirinto (String nomeFile, LabirintoBuilder labirintoBuilder) throws FileNotFoundException, FormatoFileNonValidoException {
		//LabirintoBuilder labirintoBuilder = new LabirintoBuilder(this);
		CaricatoreLabirinto c = new CaricatoreLabirinto (nomeFile,labirintoBuilder);
		c.carica();
		this.stanzaIniziale = c.getStanzaIniziale();
...
//		}
		...
		private LabirintoBuilder(String labirinto) throws FileNotFoundException, FormatoFileNonValidoException {
			this.mappaLabirinto = new HashMap<String, Stanza>();
...
//		}
		...
		public LabirintoBuilder addStrega(String nome, String nomeStanzaPersonaggio, String presentazione) {
			//Strega strega = new Strega (nome, Strega.PRESENTAZIONE);
...
//		public LabirintoBuilder addPersonaggio(Class <? extends AbstractPersonaggio> c ,String nome, String nomeAttrezzoDelPersonaggio, int pesoAttrezzoDelPersonaggio, String nomeStanzaPersonaggio, String presentazione) throws NoSuchMethodException{
//			c.newIstance(new Object[] {new String (nome), new String (presentazione), new Attrezzo (nomeAttrezzoDelPersonaggio, pesoAttrezzoDelPersonaggio)});
//			c.getConstructor(new Class[] {new String (nome), new String (presentazione), new Attrezzo (nomeAttrezzoDelPersonaggio, pesoAttrezzoDelPersonaggio)}).newInstance(nome, presentazione, new Attrezzo (nomeAttrezzoDelPersonaggio, pesoAttrezzoDelPersonaggio));
//		}
