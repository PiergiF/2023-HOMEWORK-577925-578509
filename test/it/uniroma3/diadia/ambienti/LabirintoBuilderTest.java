...
//	}
	...
	@Before
	public void setUp() throws Exception {
		labirintoBuilder = Labirinto.newBuilder("labirintoTest.txt");
	}
...
//	}
	...
	@Test
	public void testMonolocale() {
		labirintoBuilder.addStanza(nomeStanzaIniziale).addStanza(nomeStanzaVincente);
		assertTrue(labirintoBuilder.getMappaStanze().containsKey(nomeStanzaIniziale) && labirintoBuilder.getMappaStanze().containsKey(nomeStanzaVincente));
	}
...
//	}
	...
	@Test
	public void testMonolocaleConAttrezzo() {
		labirintoBuilder.addStanza(nomeStanzaIniziale).addAttrezzo("spada",1,nomeStanzaIniziale).addStanza(nomeStanzaVincente).addAttrezzo("spadina", 3, nomeStanzaVincente);
		assertEquals(nomeStanzaIniziale,labirintoBuilder.getMappaStanze().get(nomeStanzaIniziale).getNome());
		assertEquals(nomeStanzaVincente,labirintoBuilder.getMappaStanze().get(nomeStanzaVincente).getNome());
		assertEquals("spada",labirintoBuilder.getMappaStanze().get(nomeStanzaIniziale).getAttrezzo("spada").getNome());
		assertEquals("spadina",labirintoBuilder.getMappaStanze().get(nomeStanzaVincente).getAttrezzo("spadina").getNome());
	}
...
//	}
	...
	@Test
	public void testMonolocaleConAttrezzoSingoloDuplicato() {
		labirintoBuilder.addStanza(nomeStanzaIniziale).addAttrezzo("spada",1,nomeStanzaIniziale).addAttrezzo("spada",1,nomeStanzaIniziale);
		int size = labirintoBuilder.getMappaStanze().get(nomeStanzaIniziale).getAttrezzi().size();
		assertTrue(size==1);
		assertEquals(Arrays.asList(new Attrezzo("spada",1)),labirintoBuilder.getMappaStanze().get(nomeStanzaIniziale).getAttrezzi());
	}
...
//	}
	...
	public void testBilocale() {
		labirintoBuilder.addStanza(nomeStanzaIniziale).addStanza(nomeStanzaVincente)
				.addAdiacenza(nomeStanzaIniziale, nomeStanzaVincente, "nord")
				.addAdiacenza(nomeStanzaVincente, nomeStanzaIniziale, "sud");
		assertEquals(labirintoBuilder.getMappaStanze().get(nomeStanzaVincente),labirintoBuilder.getMappaStanze().get(nomeStanzaIniziale).getStanzaAdiacente("nord"));
		assertEquals(Collections.singletonList("nord"),labirintoBuilder.getMappaStanze().get(nomeStanzaIniziale).getDirezioni());
		assertEquals(Collections.singletonList("sud"),labirintoBuilder.getMappaStanze().get(nomeStanzaVincente).getDirezioni());
	}
...
//	}
	...
	public void testTrilocale(){
		Labirinto trilocale = labirintoBuilder
				...
				.setStanzaIniziale(nomeStanzaIniziale)
				.addAttrezzo("sedia", 1, nomeStanzaIniziale)
				.addStanza("biblioteca")
				.addAdiacenza(nomeStanzaIniziale, "biblioteca", "sud")
				.addAdiacenza("biblioteca", nomeStanzaIniziale, "nord")
				.addAttrezzo("libro antico", 5, "biblioteca")
				.addStanza(nomeStanzaVincente)
				.setStanzaVincente(nomeStanzaVincente)
				.addAdiacenza("biblioteca", nomeStanzaVincente, "est")
				.addAdiacenza(nomeStanzaVincente,"biblioteca" , "ovest")
				.getLabirinto();	
		assertEquals(nomeStanzaIniziale, trilocale.getStanzaIniziale().getNome());
	...
	public void testTrilocaleConStanzaDuplicata() {
				...
				.getLabirinto();
				System.out.print(labirintoBuilder.getMappaStanze());
	...
	public void testImpostaStanzaInizialeCambiandola() {
		Labirinto maze = labirintoBuilder
				.addStanza(this.nomeStanzaIniziale)
				.setStanzaIniziale(this.nomeStanzaIniziale)
				.addStanza("nuova iniziale")
				.setStanzaIniziale("nuova iniziale")
				.getLabirinto();
